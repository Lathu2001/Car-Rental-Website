    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 relative overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-12">
          <div className="inline-flex items-center justify-center w-20 h-20 bg-white backdrop-blur-lg rounded-full mb-6 shadow-xl border border-white/20">
            <Receipt className="w-10 h-10 text-blue-600" />
          </div>
          <h1 className="text-5xl font-bold text-gray-900 mb-4 bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">
            My Bookings
          </h1>
          <p className="text-gray-700 text-xl mb-6">Manage your rental history and upcoming trips</p>
          {userEmail && (
            <div className="inline-flex items-center bg-white/80 backdrop-blur-lg rounded-full px-8 py-3 shadow-lg border border-white/20">
        ...
        {bookings.length === 0 ? (
          <div className="text-center">
            <div className="bg-white/80 backdrop-blur-lg rounded-3xl p-16 max-w-lg mx-auto border border-white/20 shadow-xl">
              <div className="w-32 h-32 bg-gradient-to-br from-blue-100 to-purple-100 rounded-full flex items-center justify-center mx-auto mb-8">
                <Car className="w-16 h-16 text-blue-600" />
              </div>
              <h3 className="text-3xl font-bold text-gray-900 mb-6">No Bookings Yet</h3>
              <p className="text-gray-700 leading-relaxed text-lg">
                You haven't made any bookings yet. Start exploring our premium fleet and book your first adventure!
              </p>
              <button className="mt-8 bg-gradient-to-r from-blue-600 to-purple-600 text-white px-8 py-3 rounded-full font-semibold hover:shadow-lg transition-all duration-300 transform hover:scale-105">
                Browse Vehicles
              </button>
            </div>
          </div>
          ...
          <div className="max-w-7xl mx-auto space-y-8">
            {bookings.map((booking, index) => (
              <div
                key={booking._id}
                className="bg-white/90 backdrop-blur-lg rounded-3xl shadow-xl border border-white/20 hover:shadow-2xl transition-all duration-500 hover:scale-[1.01] overflow-hidden"
                style={{
              ...
              >
                ...
                <div className="bg-gradient-to-r from-blue-50 to-purple-50 p-8 border-b border-gray-100">
                  <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
                    <div className="flex items-center">
                      <div className="w-20 h-20 bg-gradient-to-br from-blue-500 via-purple-500 to-indigo-500 rounded-2xl flex items-center justify-center mr-6 shadow-lg">
                ...
                <div className="p-8">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                    ...
                    <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-2xl p-6 border border-purple-200">
                      <div className="flex items-center mb-3">
                        ...
                        <div>
                          <p className="text-sm font-medium text-purple-800">End Date</p>
                    ...
                    <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-2xl p-6 border border-green-200">
                      <div className="flex items-center mb-3">
                        ...
                        <div>
                          <p className="text-sm font-medium text-green-800">Driver Service</p>
                          <div className="mt-1">
                    ...
                    <div className="bg-gradient-to-br from-indigo-50 to-indigo-100 rounded-2xl p-6 border border-indigo-200">
                      <div className="flex items-center mb-3">
                        <div className="w-12 h-12 bg-indigo-500 rounded-xl flex items-center justify-center mr-3">
                          {getPaymentMethodIcon(booking.paymentMethod)}
                        </div>
                        <div>
                          <p className="text-sm font-medium text-indigo-800">Payment Method</p>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                      ...
                      <div className="text-center">
                        ...
                        {booking.remainingAmount > 0 && (
                          <p className="text-xs text-orange-600 mt-1">Due at pickup</p>
                        )}
                      </div>
                    </div>
                  ...
                  {/* Action Buttons */}
                  {booking.remainingAmount > 0 && booking.bookingStatus === 'confirmed' && (
