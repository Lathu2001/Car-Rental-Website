        ...
        <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white p-8 rounded-lg border-2 border-gray-200 shadow-[0_10px_25px_-5px_rgba(0,0,0,0.1)] hover:shadow-[0_15px_30px_-5px_rgba(0,0,0,0.15)] transition-all duration-300">
            ...
            <form onSubmit={handleReviewSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                className={`w-full py-3 px-6 rounded-lg font-bold text-lg transition-all duration-300 shadow-md bg-blue-600 hover:bg-blue-700 text-white hover:shadow-lg`}
              >
                Submit Your Review
              </button>
            </form>
