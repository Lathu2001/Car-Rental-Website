...
const AdminFooter = () => {
  return (
    ...
    >
      {/* Background (subtle on desktop, disabled on motion-reduce) */}
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
        {/* Main (cards now equal height on desktop) */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-10 items-stretch mb-10 lg:mb-12">
          ...
          <section className="lg:col-span-6 group">
            <div className="h-full min-h-[360px] lg:min-h-[380px] flex flex-col backdrop-blur-sm bg-white/5 rounded-2xl p-5 sm:p-6 border border-white/10 transition-all duration-200 hover:-translate-y-1 hover:bg-white/10 hover:ring-1 hover:ring-white/20">
              ...
              {/* spacer to push content evenly if you later add buttons */}
          ...
          <nav aria-label="Quick links" className="lg:col-span-3 group">
            <div className="h-full min-h-[360px] lg:min-h-[380px] flex flex-col backdrop-blur-sm bg-white/5 rounded-2xl p-5 sm:p-6 border border-white/10 transition-all duration-200 hover:-translate-y-1 hover:bg-white/10 hover:ring-1 hover:ring-white/20">
              ...
              <ul className="space-y-3">
                <li>
                  <Link to="/admin-dashboard" className="flex items-center gap-2 text-gray-300 hover:text-cyan-300">
                    <ArrowRight className="w-4 h-4 opacity-70" />
                    Cars
                  </Link>
                </li>
                <li>
                  <Link to="/Admin-Booking" className="flex items-center gap-2 text-gray-300 hover:text-cyan-300">
                    <ArrowRight className="w-4 h-4 opacity-70" />
                    Add Booking
                  </Link>
                </li>
                <li>
                  <Link to="/All-bookings" className="flex items-center gap-2 text-gray-300 hover:text-cyan-300">
                    <ArrowRight className="w-4 h-4 opacity-70" />
                    Booking
                  </Link>
                </li>
                <li>
                  <Link to="/user-detail" className="flex items-center gap-2 text-gray-300 hover:text-cyan-300">
                    <ArrowRight className="w-4 h-4 opacity-70" />
                    User
                  </Link>
                </li>
                <li>
                  <Link to="/User-Rewiews" className="flex items-center gap-2 text-gray-300 hover:text-cyan-300">
                    <ArrowRight className="w-4 h-4 opacity-70" />
                    Reviews
                  </Link>
                </li>
